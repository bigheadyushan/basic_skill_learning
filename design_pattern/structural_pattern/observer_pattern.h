#ifndef BASIC_SKILL_LEARNING_DESIGN_PATTERN_OBSERVER_PATTERN_H
#define BASIC_SKILL_LEARNING_DESIGN_PATTERN_OBSERVER_PATTERN_H
...
#endif //BASIC_SKILL_LEARNING_DESIGN_PATTERN_OBSERVER_PATTERN_H
